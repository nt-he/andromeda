...
description = """Andromeda is a multi-use bot, that has many uses. It uses discord.ext and a cog system. Thank you for using me :D"""
...
async def credits(ctx):
    ...
    embed.set_author(name="Andromeda", icon_url=pfp)
...
async def information(ctx):
    ...
    await ctx.send(f"{ctx.author.mention} :wave: Hey there! As you know, I am Andromeda! By running this, you would like to see this important information. Please read the embed below for that information you requested (it is also at the bottom of https://bot.oscie.net)", embed=anembed)
